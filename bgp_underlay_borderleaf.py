...
bgp_configurations = {
    'borderleaf1-DC1': {
        'asn': 65103,
        'loopback': '192.168.101.21',
        'spines_asn': 65100,
        'neighbors': ['192.168.103.25', '192.168.103.27', '192.168.103.29'],
        'mlag_neighbor': '192.168.255.2',
        'DCI_neighbor': '192.168.254.1'
    },
    'borderleaf2-DC1': {
        'asn': 65103,
        'loopback': '192.168.102.22',
        'spines_asn': 65100,
        'neighbors': ['192.168.103.31', '192.168.103.33', '192.168.103.35'],
        'mlag_neighbor': '192.168.255.1',
        'DCI_neighbor': '192.168.254.3'
    },
    'borderleaf1-DC2': {
        'asn': 65203,
        'loopback': '192.168.201.21',
        'spines_asn': 65200,
        'neighbors': ['192.168.203.25', '192.168.203.27', '192.168.203.29'],
        'mlag_neighbor': '192.168.255.2',
        'DCI_neighbor': '192.168.254.5'
    },
    'borderleaf2-DC2': {
        'asn': 65203,
        'loopback': '192.168.202.22',
        'spines_asn': 65200,
        'neighbors': ['192.168.203.31', '192.168.203.33', '192.168.203.35'],
        'mlag_neighbor': '192.168.255.1',
        'DCI_neighbor': '192.168.254.7'
    }
}
...
def configure_bgp(node_name, asn, loopback, spines_asn, neighbors):
    try:
        ...
        for neighbor in neighbors:
            ...
            commands.append(f'neighbor {DCI_neighbor} remote-as 65000')
            commands.append(f'neighbor {DCI_neighbor} send-community')
            commands.append(f'neighbor {DCI_neighbor} maximum-routes 12000')
            commands.append(f'neighbor {DCI_neighbor} peer group DCI')
...
for node_name, config in bgp_configurations.items():
    ...
    DCI_neighbor = config['DCI_neighbor']
